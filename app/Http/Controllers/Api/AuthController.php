...
class AuthController extends Controller
{
    ...
    public function refresh(Request $request)
    {
        try {
            ...
            // 1. Validate refresh token and authenticate user
            ...
            // 2. Check if refresh token exists in session table
    ...
    public function validateToken(Request $request)
    {
        try {
            ...
            // 2. Check if token exists in session table and not expired
