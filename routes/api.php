...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('auth')->group(function () {
        ...
        Route::post('/refresh', [AuthController::class, 'refresh']); // ? No 'middleware' needed here
        Route::post('/validate-token', [AuthController::class, 'validateToken']); // ? Fixed typo (was validate-token`)
    ...
    Route::post('/upload-circle-image', [ImageController::class, 'uploadCircleImage']);
